...
export type PageData = Omit<PageParentData, keyof Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/(dashboard)/invoices/[id]/+page.js').load>>>> & Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/(dashboard)/invoices/[id]/+page.js').load>>>;
